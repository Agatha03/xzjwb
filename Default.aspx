...
&nbsp;<asp:LinkButton ID="LinkButton3" runat="server" CssClass="style50" PostBackUrl="~/manage/login.aspx">登录</asp:LinkButton>
              ...
              <tr>
                ...
                <asp:DataList ID="jxxw" runat="server"    DataKeyField="NewsId" onitemcommand="jxxw_ItemCommand" 
                                    >
                                    <ItemTemplate>
                                        <table cellspacing="0" >
                                            <tr> 
          ...
          <table style="width: 1024px" align="center">
            <tr  >
                ...
                <asp:ImageButton ID="ImageButton3" runat="server" Height="20px" 
                                    ImageUrl="~/images/icon_more.png" style="text-align: right" 
                        Width="20px"  PostBackUrl="~/sjjx.aspx"/>
                    <hr size="2" color="#0a778b" width="100%"> 
                </td>
